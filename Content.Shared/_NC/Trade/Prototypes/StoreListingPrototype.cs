...
/// <summary>
/// Shared‑прототип листинга магазина: один товар, его цена, валюта и режим (покупка, продажа, обмен).
/// </summary>
...
/// <summary>
/// Режим работы листинга: покупка, продажа, обмен.
/// </summary>
public enum StoreMode
{
    Buy,     // Купить у магазина
    Sell,    // Продать магазину
    Exchange // Обменять предмет на предмет/валюту
}
